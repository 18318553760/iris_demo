...
func (p *ProductController) PostUpdate ()  {
	...
	dec := common.NewDecoder(&common.DecoderOptions{TagName:"iris"})
	...
	p.Ctx.Redirect("/admin/product/all")
}
...
func (p *ProductController) GetManager() mvc.View {
	...
	return mvc.View{
		Name:"/admin/product/manager.html",
		Data:iris.Map{
			"product":product,
		},
	}
